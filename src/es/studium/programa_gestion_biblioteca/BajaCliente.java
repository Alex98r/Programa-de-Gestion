...
public class BajaCliente implements WindowListener, ActionListener {
	...
	Label lblElegir = new Label("Elegir el cliente a borrar:");
	Label lblConfirmar = new Label("¿Seguro de borrar el cliente ");
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource().equals(btnCancelar)) {
			...
			if (choClientes.getSelectedIndex() != 0) {
				...
				lblConfirmar.setText("¿Seguro de borrar el cliente '" + choClientes.getSelectedItem() + "'?");
			...
			int resultado = conexion.eliminarCliente(tabla[0]); // idCliente --> DELETE
